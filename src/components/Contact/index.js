  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formData = {
        ...
        to_email: 'ashravgurung08@gmail.com',
      ...
      setMessage("Failed to send email. Please email me directly at ashravgurung08@gmail.com");
      setError(true);
      setOpen(true);
      setShowSuccess(false);
    } finally {
  ...
  return (
    <Container id="contact">
      <Wrapper>
        <Title>Contact</Title>
        <Desc>
          Feel free to reach out to me at <DirectEmailLink href="mailto:ashravgurung08@gmail.com">ashravgurung08@gmail.com</DirectEmailLink> or use the form below.
        </Desc>
